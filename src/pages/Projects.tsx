...
const projects = [
  ...
  },
  {
    ...
    description: 'Created an application that enables non-technical professionals to interact with MySQL databases, by converting their english phrases to SQL queries using a LLM Gemini-Pro.',
  ...
  },
  {
    ...
    description: 'Created an app that classifies Nigerian NUBAN account numbers into their respective banks using a Spring Boot service, enhancing transaction routing accuracy. Also showed another application of the classification algorithm in USSD apps',

    ...
    <main className={styles.about}>
      <section className={styles.content}>
        ...
        <div className={styles.textBlock}>
          ...
          <p className={styles.description}> My work revolves around solving complex problems of scale and security. I&apos;ve 
            built real-time transaction decisioning platforms engineered to handle high-volume request loads, reduced latency by 
            30% through strategic caching and optimization, and migrated monolithic architectures to event-driven microservices. </p>
